...
namespace System.Net.NetworkInformation
{
    internal sealed class SunOSIPGlobalProperties : UnixIPGlobalProperties
    {
        ...
        public override IPGlobalStatistics GetIPv4GlobalStatistics() => throw new PlatformNotSupportedException();

        public override IPGlobalStatistics GetIPv6GlobalStatistics() => throw new PlatformNotSupportedException();
