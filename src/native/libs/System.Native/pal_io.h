...
/*
* Assocate an event port with an event source
*/
PALEXPORT int32_t SystemNative_PortAssociate(intptr_t port, intptr_t pFileObj, char *dirPath, TimeSpec *mtime, uint32_t events, intptr_t cookie);

/*
* Dissocate an event port with an event source
*/
