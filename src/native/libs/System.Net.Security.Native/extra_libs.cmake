...
macro(append_extra_security_libs NativeLibsExtra)
  ...
  elseif(HAVE_SUNOS_GSSAPI)
     find_library(LIBGSS NAMES gss)
     if(LIBGSS STREQUAL LIBGSS-NOTFOUND)
        message(FATAL_ERROR "Cannot find libgss and System.Net.Security.Native cannot build without it. Try installing krb5 package or check /usr/lib/64")
     endif()
